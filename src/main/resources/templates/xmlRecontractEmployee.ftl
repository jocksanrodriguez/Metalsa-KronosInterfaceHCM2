		...
		<Personality>
		 <PersonInformationData>
		    <PersonInformation>
		       ...
		       <CustomDates>
                  <CustomDate CustomDateTypeName="MX-FECHA CONTRATACION" Date="${customDate}" />
               </CustomDates>
		       ...
		       <PersonData>
		          <Person LastName="${lastName}" FirstName="${firstName}" PersonNumber="${personNumber}" FingerRequiredFlag="True">
